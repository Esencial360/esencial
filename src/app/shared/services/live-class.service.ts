...
export class LiveClassService {
  ...
  getAllClasses(filters?: {
    ...
    return this.http.get<ApiResponse<LiveClass[]>>(this.apiUrl, { params });
  }
  ...
  createClass(classData: Partial<LiveClass>): Observable<ApiResponse<LiveClass>> {
    return this.http.post<ApiResponse<LiveClass>>(this.apiUrl, classData);
  }

  // Actualizar el estado de una clase
  updateClassStatus(id: string, status: string): Observable<ApiResponse<LiveClass>> {
    ...
    updateClass(id: string, classData: Partial<LiveClass>): Observable<ApiResponse<LiveClass>> {
  ...
  registerToClass(classId: string, userId: string): Observable<ApiResponse<LiveClass>> {
  ...
  getLiveClassesWithPolling(intervalMs: number = 30000): Observable<ApiResponse<LiveClass[]>> {
  ...
  getYouTubeThumbnail(videoId: string, quality: 'default' | 'medium' | 'high' | 'maxres' = 'high'): string {
